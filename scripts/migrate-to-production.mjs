...
const replacements = [
  ...
  [/Configurez votre environnement sandbox Nova Gestion\./g, "Configurez votre organisation Nova Gestion."],
  ...
  [/Document sandbox — sans valeur légale\. Téléchargement simulé uniquement\./g, "Document généré par Nova Gestion."],
